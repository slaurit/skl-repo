      ...
      *| DATE GENERATED: 06/07/2021 17:50                              |
      *| ID: 2d46bf6b-4ebb-4a6c-9eb4-8d57ac2f17f7                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_TEST1                                                    |
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          3 ZUT00000031.
            5 PIC X(6) DISPLAY VALUE '01ICUS'.
          3 ZUT00000032.
            5 PIC X(10) VALUE X'E28396A3A34040404040'.
          3 ZUT00000033.
          ...
          3 ZUT00000034.
            5 PIC X(10) DISPLAY VALUE SPACES.
          3 ZUT00000035.
            5 PIC X(20) DISPLAY VALUE '1965-09-30Tracey Isl'.
            5 PIC X(3) DISPLAY VALUE 'and'.
            5 PIC X(3) DISPLAY VALUE SPACES.
          3 ZUT00000036.
            5 PIC X(10) VALUE X'40404040F1404040E3C2'.
          3 ZUT00000037.
            5 PIC X(9) DISPLAY VALUE '14TV  000'.
            5 PIC X(1) DISPLAY VALUE SPACES.
          3 ZUT00000038.
            5 PIC X(6) VALUE SPACES.
          3 ZUT00000039.
            5 PIC X(10) VALUE SPACES.
          3 ZUT0000003A.
            5 PIC X(10) DISPLAY VALUE '   001 911'.
          3 ZUT0000003B.
            5 PIC X(8) VALUE X'F9F1F14040404040'.
          3 ZUT0000003C.
            5 PIC X(8) VALUE X'4040404040D9C5C6'.
          3 ZUT0000003D.
            5 PIC X(20) DISPLAY VALUE 'ROOM@TBHOLDINGS.COM '.
            5 PIC X(20) DISPLAY VALUE '                    '.
            5 PIC X(20) DISPLAY VALUE '                    '.
            5 PIC X(20) DISPLAY VALUE '                    '.
            5 PIC X(20) DISPLAY VALUE '                    '.
            5 PIC X(20) DISPLAY VALUE '  34  PI101OO 000077'.
            5 PIC X(20) DISPLAY VALUE '99 123456        019'.
            5 PIC X(20) DISPLAY VALUE '62 811234        A.P'.
            5 PIC X(18) DISPLAY VALUE 'andy@beebhouse.com'.
            5 PIC X(77) DISPLAY VALUE SPACES.
          3 ZUT0000003E.
            5 PIC X(255) DISPLAY VALUE SPACES.
          3 ZUT0000003F.
            5 PIC X(31854) DISPLAY VALUE SPACES.
       ...
       1 AZ-COMPARE-ITEM-NAMES.
         ...
         3 ZUT00000060.
            ...
            5 PIC X(19) DISPLAY VALUE 'UEST OF DFHCOMMAREA'.
       1 AZ-COMPARE-WORK-ITEMS.
          3 ZUT00000041 PIC X(6) OCCURS 2.
          3 ZUT00000043 PIC 9(2) OCCURS 2.
          3 ZUT00000045 PIC 9(10) OCCURS 2.
          3 ZUT00000047 PIC X(20) OCCURS 2.
          3 ZUT00000049 PIC X(10) OCCURS 2.
          3 ZUT0000004B PIC X(10) OCCURS 2.
          3 ZUT0000004D PIC X(26) OCCURS 2.
          3 ZUT0000004F PIC X(20) OCCURS 2.
          3 ZUT00000051 PIC X(10) OCCURS 2.
          3 ZUT00000053 PIC X(12) OCCURS 2.
          3 ZUT00000055 PIC X(20) OCCURS 2.
          3 ZUT00000057 PIC X(10) OCCURS 2.
          3 ZUT00000059 PIC X(16) OCCURS 2.
          3 ZUT0000005B PIC X(16) OCCURS 2.
          3 ZUT0000005D PIC X(255) OCCURS 2.
          3 ZUT0000005F PIC X(255) OCCURS 2.
          3 ZUT00000061 PIC X(31854) OCCURS 2.
       01 AZ-CONVERT.
         03 AZ-CONVERT-HEXIN  PIC X(1).
         03 AZ-CONVERT-HEXVAL PIC X(2).
         03 AZ-HEXSTR PIC X(16) VALUE "0123456789ABCDEF".
      ...
      * EVALUATE OUTPUT VALUE
           MOVE 0 TO RETURN-CODE
           IF CA-REQUEST-ID OF DFHCOMMAREA = ZUT00000031 THEN
             CONTINUE
           ELSE
             MOVE CA-REQUEST-ID OF DFHCOMMAREA TO ZUT00000041(1)
             MOVE ZUT00000031 TO ZUT00000041(2)
           ...
           IF (CA-RETURN-CODE OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-RETURN-CODE OF DFHCOMMAREA TO ZUT00000043(1)
             MOVE 0 TO ZUT00000043(2)
           ...
           IF (CA-CUSTOMER-NUM OF DFHCOMMAREA IS NUMERIC)
             ...
             CONTINUE
           ELSE
             MOVE CA-CUSTOMER-NUM OF DFHCOMMAREA TO ZUT00000045(1)
             MOVE 2 TO ZUT00000045(2)
           ...
           END-IF
           IF CA-ISSUE-DATE OF CA-POLICY-COMMON OF CA-POLICY-REQUEST
           OF DFHCOMMAREA = ZUT00000033 THEN
             CONTINUE
           ELSE
             MOVE CA-ISSUE-DATE OF CA-POLICY-COMMON OF
           CA-POLICY-REQUEST OF DFHCOMMAREA TO ZUT00000049(1)
             MOVE ZUT00000033 TO ZUT00000049(2)
           ...
           END-IF
           IF CA-EXPIRY-DATE OF CA-POLICY-COMMON OF CA-POLICY-REQUEST
           OF DFHCOMMAREA = ZUT00000034 THEN
             CONTINUE
           ELSE
             MOVE CA-EXPIRY-DATE OF CA-POLICY-COMMON OF
           CA-POLICY-REQUEST OF DFHCOMMAREA TO ZUT0000004B(1)
             MOVE ZUT00000034 TO ZUT0000004B(2)
           ...
           END-IF
           IF CA-LASTCHANGED OF CA-POLICY-COMMON OF CA-POLICY-REQUEST
           OF DFHCOMMAREA = ZUT00000035 THEN
             CONTINUE
           ELSE
             MOVE CA-LASTCHANGED OF CA-POLICY-COMMON OF
           CA-POLICY-REQUEST OF DFHCOMMAREA TO ZUT0000004D(1)
             MOVE ZUT00000035 TO ZUT0000004D(2)
           ...
           END-IF
           IF CA-BROKERID-AZ OF CA-POLICY-COMMON OF CA-POLICY-REQUEST
           OF DFHCOMMAREA = ZUT00000036 THEN
             CONTINUE
           ELSE
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 10
               MOVE CA-BROKERID-AZ OF CA-POLICY-COMMON OF
           ...
           AZ-CONVERT-HEXIN
             ...
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 10
               MOVE ZUT00000036(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
           ...
           END-IF
           IF CA-BROKERSREF OF CA-POLICY-COMMON OF CA-POLICY-REQUEST
           OF DFHCOMMAREA = ZUT00000037 THEN
             CONTINUE
           ELSE
             MOVE CA-BROKERSREF OF CA-POLICY-COMMON OF
           CA-POLICY-REQUEST OF DFHCOMMAREA TO ZUT00000051(1)
             MOVE ZUT00000037 TO ZUT00000051(2)
             SET AZ-COMPARE-ITEM-NAME-PTR TO ADDRESS OF ZUT00000050
             MOVE LENGTH OF ZUT00000050 TO AZ-COMPARE-ITEM-NAME-LEN
             SET AZ-COMPARE-ITEM-VALUE-PTR TO ADDRESS OF ZUT00000051(1)
             MOVE 10 TO AZ-COMPARE-ITEM-VALUE-LEN
             SET AZ-COMPARE-ITEM-EXP-VALUE-PTR TO ADDRESS OF
           ZUT00000051(2)
             MOVE 10 TO AZ-COMPARE-ITEM-EXP-VALUE-LEN
           ...
           END-IF
           IF CA-PAYMENT-AZ OF CA-POLICY-COMMON OF CA-POLICY-REQUEST
           OF DFHCOMMAREA = ZUT00000038 THEN
             CONTINUE
           ELSE
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 6
               MOVE CA-PAYMENT-AZ OF CA-POLICY-COMMON OF
           ...
           AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000053(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 6
               MOVE ZUT00000038(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000053(2)(AZ-J:2)
             END-PERFORM
           ...
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000055(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 10
               MOVE ZUT00000039(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000055(2)(AZ-J:2)
             END-PERFORM
           ...
           END-IF
           IF CA-C-DATE OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA = ZUT0000003A THEN
             CONTINUE
           ELSE
             MOVE CA-C-DATE OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA TO ZUT00000057(1)
             MOVE ZUT0000003A TO ZUT00000057(2)
           ...
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000059(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 8
               MOVE ZUT0000003B(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000059(2)(AZ-J:2)
             END-PERFORM
           ...
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT0000005B(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 8
               MOVE ZUT0000003C(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT0000005B(2)(AZ-J:2)
             END-PERFORM
           ...
           END-IF
           IF CA-C-CAUSE OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA = ZUT0000003D THEN
             CONTINUE
           ELSE
             MOVE CA-C-CAUSE OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA TO ZUT0000005D(1)
             MOVE ZUT0000003D TO ZUT0000005D(2)
           ...
           END-IF
           IF CA-C-OBSERVATIONS OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA = ZUT0000003E THEN
             CONTINUE
           ELSE
             MOVE CA-C-OBSERVATIONS OF CA-CLAIM OF CA-POLICY-REQUEST
           OF DFHCOMMAREA TO ZUT0000005F(1)
             MOVE ZUT0000003E TO ZUT0000005F(2)
           ...
           END-IF
           IF CA-C-FILLER OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA = ZUT0000003F THEN
             CONTINUE
           ELSE
             MOVE CA-C-FILLER OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA TO ZUT00000061(1)
             MOVE ZUT0000003F TO ZUT00000061(2)
      ...
      * SET INPUT VALUE
           ...
           DFHEIBLK DFHCOMMAREA.
           DISPLAY 'PGM_INPT_LGICDB01 CHECK VALUES...'.
           MOVE 0 TO RETURN-CODE.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           DFHEIBLK DFHCOMMAREA.
           DISPLAY 'PGM_OUTP_LGICDB01 INPUT VALUES...'.
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '2d46bf6b-4ebb-4a6c-9eb4-8d57ac2f17f7'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
