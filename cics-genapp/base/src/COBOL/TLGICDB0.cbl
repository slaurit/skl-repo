      ...
      *| DATE GENERATED: 02/14/2024 14:27                              |
      *| ID: f0c1750f-ac9d-452d-b992-e1ed996c2078                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| ZUNIT TEST_TEST1                                              |
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          ...
          3 AZU00000001.
            5 PIC X(10) VALUE X'D396A489A24040404040'.
          3 AZU00000002.
            5 PIC X(3) DISPLAY VALUE 'Pug'.
            5 PIC X(7) DISPLAY VALUE SPACES.
          3 AZU00000003.
            5 PIC X(10) DISPLAY VALUE SPACES.
          3 AZU00000004.
            5 PIC X(20) DISPLAY VALUE '1969-09-06Picnic Bas'.
            5 PIC X(3) DISPLAY VALUE 'ket'.
            5 PIC X(3) DISPLAY VALUE SPACES.
          3 AZU00000005.
            5 PIC X(10) VALUE X'40404040F2F14040D7D7'.
          3 AZU00000006.
            5 PIC X(9) DISPLAY VALUE '159DD 000'.
          ...
          3 AZU00000009.
            5 PIC X(10) DISPLAY VALUE '   0208 34'.
          3 AZU0000000A.
            5 PIC X(8) VALUE X'F4F3F4F440404040'.
          3 AZU0000000B.
            5 PIC X(8) VALUE SPACES.
          3 AZU0000000C.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           IF (ZUT000000AE OF ZUT000000AB IS NUMERIC)
               AND (ZUT000000AE OF ZUT000000AB = 4) THEN
             CONTINUE
           ELSE
             MOVE ZUT000000AE OF ZUT000000AB TO AZU00000014(1)
             MOVE 4 TO AZU00000014(2)
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          3 AZU00000031.
            5 PIC X(6) DISPLAY VALUE '01ICUS'.
          3 AZU00000032.
            5 PIC X(10) VALUE X'C7998188819440404040'.
          3 AZU00000033.
            5 PIC X(8) DISPLAY VALUE 'Cuthbert'.
            5 PIC X(2) DISPLAY VALUE SPACES.
          3 AZU00000034.
            5 PIC X(10) DISPLAY VALUE SPACES.
          3 AZU00000035.
            5 PIC X(10) DISPLAY VALUE '1967-01-03'.
            5 PIC X(16) DISPLAY VALUE SPACES.
          3 AZU00000036.
            5 PIC X(10) VALUE X'40404040F5F54040E3D9'.
          3 AZU00000037.
            5 PIC X(10) DISPLAY VALUE '68BK  0000'.
          3 AZU00000038.
            5 PIC X(6) VALUE X'F1F1F0F140F4'.
          3 AZU00000039.
            5 PIC X(10) VALUE X'F9F9F7F8F74040404040'.
          3 AZU0000003A.
            5 PIC X(10) DISPLAY VALUE '   0208 34'.
          3 AZU0000003B.
            5 PIC X(8) VALUE X'F4F3F4F440404040'.
          3 AZU0000003C.
            5 PIC X(8) VALUE X'4040404040C14BC3'.
          3 AZU0000003D.
            5 PIC X(20) DISPLAY VALUE 'ut@CG.co.uk         '.
            5 PIC X(20) DISPLAY VALUE '                    '.
            5 PIC X(20) DISPLAY VALUE '                    '.
            5 PIC X(20) DISPLAY VALUE '                    '.
            5 PIC X(20) DISPLAY VALUE '                    '.
            5 PIC X(20) DISPLAY VALUE '  21  PP159DD 000   '.
            5 PIC X(20) DISPLAY VALUE '                 020'.
            5 PIC X(8) DISPLAY VALUE '8 344344'.
            5 PIC X(107) DISPLAY VALUE SPACES.
          3 AZU0000003E.
            5 PIC X(255) DISPLAY VALUE SPACES.
          3 AZU0000003F.
            5 PIC X(31854) DISPLAY VALUE SPACES.
      ...
      * EVALUATE OUTPUT VALUE
           ...
           END-IF
           IF (ZUT000000AE OF ZUT000000AB IS NUMERIC)
               AND (ZUT000000AE OF ZUT000000AB = 5) THEN
             CONTINUE
           ELSE
             MOVE ZUT000000AE OF ZUT000000AB TO AZU00000045(1)
             MOVE 5 TO AZU00000045(2)
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE 'f0c1750f-ac9d-452d-b992-e1ed996c2078'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
      ...
      *+---------------------------------------------------------------+
      *| ZUNIT PROGRAM FOR EXEC CICS ABEND                             |
      *|    FUNCTION CODE: 0E0C                                        |
      *| TEST CASE VERSION: 102                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
      ...
      *+---------------------------------------------------------------+
      *| ZUNIT PROGRAM FOR EXEC CICS ASKTIME                           |
      *|    FUNCTION CODE: 4A02                                        |
      *| TEST CASE VERSION: 102                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
      ...
      *+---------------------------------------------------------------+
      *| ZUNIT PROGRAM FOR EXEC CICS FORMATTIME                        |
      *|    FUNCTION CODE: 4A04                                        |
      *| TEST CASE VERSION: 102                                        |
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
